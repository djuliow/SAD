      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="bg-white border border-navy/10 shadow-md">
          <CardHeader className="bg-beige border-b border-navy/10 rounded-t-xl">
            <CardTitle className="text-lg font-bold text-navy">Resep Menunggu</CardTitle>
          </CardHeader>
        ...
        <Card className="bg-white border border-navy/10 shadow-md">
          <CardHeader className="bg-beige border-b border-navy/10 rounded-t-xl">
            <CardTitle className="text-lg font-bold text-navy">Stok Rendah</CardTitle>
          </CardHeader>
            ...
            {lowStock.length > 0 ? (
              lowStock.map((med) => (
                <div key={med.id} className="flex items-center justify-between rounded-lg bg-red-50 px-3 py-2 border border-red-200/50 hover:shadow-md transition-all">
                  <span className="font-medium text-navy">{med.nama}</span>
            ...
            <table className="w-full text-sm text-left">
              ...
              <tbody className="divide-y divide-navy/5">
                {medicines.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="3" className="px-4 py-8 text-center text-navy/70">
                      Tidak ada data obat.
                    </td>
                  </tr>
                )}
